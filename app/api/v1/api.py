...
from app.api.v1.endpoints.themed_readings import router as themed_readings_router
from app.api.v1.endpoints.planetary_readings import router as planetary_readings_router
...
api_router.include_router(themed_readings_router)
api_router.include_router(planetary_readings_router)
